...
# datetime:2021/9/14 9:38
# software: PyCharm

import torch
from models.WGAN_GP import train_process, WGAN_GPModel
import dataLoader
import argparse
...
parser.add_argument('--lambda_gp',type=float,default=10.0,help='the Loss weight for gradient penalty')
# setting parameter
...
parser.add_argument('--model_name',type=str,default='WGAN_GP',help='the model')
...
if __name__ == '__main__':
    ...
    mcdamodel=WGAN_GPModel(args,datasetRootAndImageSize[args.datasetIndex][2]).to(DEVICE)
