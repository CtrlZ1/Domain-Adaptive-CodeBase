...
import torch
from models.DDC import train_process, test_process, DDCModel
import dataLoader
...
parser.add_argument('--model_name',type=str,default='DDC',help='the model')
...
if __name__ == '__main__':
    ...
    mcdamodel=DDCModel(args,DEVICE).to(DEVICE)
