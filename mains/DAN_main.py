...
# datetime:2021/9/16 9:47
# software: PyCharm

import dataLoader
import torch
from models.DAN import train_process, test_process, DANModel
...
parser.add_argument('--model_name',type=str,default='DAN',help='the model')
...
if __name__ == '__main__':
    ...
    mcdamodel=DANModel(DEVICE,args).to(DEVICE)
