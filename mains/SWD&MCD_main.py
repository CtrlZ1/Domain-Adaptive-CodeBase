...
# datetime:2021/9/19 10:54
# software: PyCharm

import dataLoader
from models.SWD_and_MCD import train_process, test_process, SWD_MCDModel
...
# model parameter
parser.add_argument('--batchSize',type=int,default=128,metavar='batchSize',help='input the batch size of training process.(default=128)')
...
parser.add_argument('--model_name',type=str,default='SWD&MCD',help='the model')
...
if __name__ == '__main__':
    ...
    mcdamodel=SWD_MCDModel(DEVICE,args).to(DEVICE)

    train_process(mcdamodel, sourceTrainLoader, targetTrainLoader,sourceTestLoader,targetTestLoader,DEVICE,datasetRootAndImageSize[args.datasetIndex][2],args.mode,args)
